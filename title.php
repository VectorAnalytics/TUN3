...
{
$hello = mysql_query("SELECT url, title, author, isbn13, price_sold, book_description from book where title like '%$title%'") or die (mysql_error());
	...
	<link rel="stylesheet" href="style.css" />
	<body>
	<h1> Book Search by Title Results </h1>
	<table border = "1">
	 <tr>
	 <th> Book Title</th>
	 <th> Authors </th>
